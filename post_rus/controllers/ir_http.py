...
#             #post_rus part start
#             if obj.description.split('!')[0] == 'post_rus':
#                     head = {
#                              "Content-Type": "application/json",
#                              "Accept": "application/json;charset=UTF-8",
#                              "Authorization": "AccessToken " + obj.description.split('!')[1],
#                              "X-User-Authorization": "Basic " + obj.description.split('!')[2]
#                     }
#                     response = requests.get(obj.description.split('!')[3], headers=head, stream=True)
#                     file_bin = ''
#                     for block in response.iter_content(1024):
#                         file_bin+=block
#                     filename = obj.datas_fname
#                     content = base64.b64encode(file_bin)
#             #post_rus part end
