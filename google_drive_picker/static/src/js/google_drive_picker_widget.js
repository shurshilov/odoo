...
odoo.define('google_drive_picker_widget', function (require) {
    "use strict";
...
/*            else {
        ...
        _onGoogleDrivePicker : function (e) {
            var self = this;
            try {
                gapi.load('auth2', {
                    'callback': self.onAuthApiLoad.bind(self)
                });
                gapi.load('picker', {
                    'callback': function() {
    ...
    registry.add("gdrive_picker", FieldPathGdrivePicker);
