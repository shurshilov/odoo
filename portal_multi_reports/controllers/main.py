...
class CustomerPortal(CustomerPortal):
    @http.route(["/report/download/public"], type="http", auth="public", website=True)
    def show_report_by_id(self, access_token, order_id, report_type, report_id, download=False):
        ...
        report_sudo = order_sudo.env["ir.actions.report"].browse(report_id).with_user(SUPERUSER_ID)
        ...
        if download:
            texthttpheaders.append(("Content-Disposition", content_disposition(filename)))
    ...
    def _order_get_page_view_values(self, order, access_token, **kwargs):
        ...
        values["available_reports"] = (
            ...
            .search([("portal_bisible", "=", True), ("model", "=", "sale.order")])
