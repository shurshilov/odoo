...
class WorkbookWriter:
    ...
    def write_worksheets(self):
        for idx, sheet in enumerate(self.wb._sheets, 1):
            sheet_node = ChildSheet(name=sheet.title, sheetId=idx, id="rId{}".format(idx))
    ...
    def write_names(self):
        ...
        for idx, sheet in enumerate(self.wb.worksheets):
            ...
            if sheet.print_titles:
                ...
                name.value = ",".join(
                    [
                        "{}!{}".format(quote_sheetname(sheet.title), r)
            ...
            if sheet.print_area:
                ...
                name.value = ",".join(
                    ["{}!{}".format(quote_sheetname(sheet.title), r) for r in sheet.print_area]
                )
                defined_names.append(name)
