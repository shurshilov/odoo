...
class Cell(StyleableObject):
    ...
    def __repr__(self):
        return "<Cell {!r}.{}>".format(self.parent.title, self.coordinate)
    ...
    def _bind_value(self, value):
        ...
        if dt == "n" or dt == "b":
            ...
            raise ValueError("Cannot convert {!r} to Excel".format(value))
...
class MergedCell(StyleableObject):
    ...
    def __repr__(self):
        return "<MergedCell {!r}.{}>".format(self.parent.title, self.coordinate)
