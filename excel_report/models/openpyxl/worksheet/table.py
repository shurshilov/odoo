...
TABLESTYLES = tuple(
    ["TableStyleMedium{}".format(i) for i in range(1, 29)]
    + ["TableStyleLight{}".format(i) for i in range(1, 22)]
    + ["TableStyleDark{}".format(i) for i in range(1, 12)]
)

PIVOTSTYLES = tuple(
    ["PivotStyleMedium{}".format(i) for i in range(1, 29)]
    + ["PivotStyleLight{}".format(i) for i in range(1, 29)]
    + ["PivotStyleDark{}".format(i) for i in range(1, 29)]
)
...
class Table(Serialisable):
    ...
    def _initialise_columns(self):
        ...
        for idx in range(min_col, max_col + 1):
            col = TableColumn(id=idx, name="Column{}".format(idx))
