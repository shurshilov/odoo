...
class WorkSheetParser:
    def __init__(
        self, src, shared_strings, data_only=False, epoch=WINDOWS_EPOCH, date_formats=set()
    ):
            ...
            if data_type == "n":
                ...
                if style_id in self.date_formats:
                    ...
                    try:
                        ...
                        msg = """Cell {} is marked as a date but the serial value {} is outside the limits for dates. The cell will be treated as an error.""".format(
                            coordinate, value
                        )
                        warn(msg)
                        data_type = "e"
    ...
    def parse_extensions(self, element):
        ...
        for e in extLst.ext:
            ...
            msg = "{} extension is not supported and will be removed".format(ext_type)
            warn(msg)
...
class WorksheetReader:
    ...
    def __init__(self, ws, xml_source, shared_strings, data_only):
        ...
        self.parser = WorkSheetParser(
            xml_source, shared_strings, data_only, ws.parent.epoch, ws.parent._date_formats
        )
        self.tables = []
