odoo.define('html_form_builder_v12_snippets.editor', function (require) {
'use strict';
...
ajax.loadXML('/html_form_builder_v12/static/src/xml/html_form_modal30.xml', qweb);

options.registry.html_form_builder_v12 = options.Class.extend({
    onBuilt: function() {
        var self = this;
...
options.registry.html_form_builder_v12_new = options.Class.extend({
    onBuilt: function() {
        var self = this;
...
// ------------------------ TEXTBOX CONFIG ----------------------
options.registry.html_form_builder_v12_field_textbox = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.textbox_config';
...
// ------------------------ TEXTAREA CONFIG ----------------------
options.registry.html_form_builder_v12_field_textarea = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.textarea_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
options.registry.html_form_builder_v12_field_checkbox_group = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.checkbox_group_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ DROPBOX CONFIG ----------------------
options.registry.html_form_builder_v12_field_dropbox = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.dropbox_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ RADIO GROUP CONFIG ----------------------
options.registry.html_form_builder_v12_field_radio_group = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.radio_group_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ DATE PICKER CONFIG ----------------------
options.registry.html_form_builder_v12_field_date_picker = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.date_picker_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
options.registry.html_form_builder_v12_field_datetime_picker = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.datetime_picker_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ CHECKBOX CONFIG ----------------------
options.registry.html_form_builder_v12_field_checkbox = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.checkbox_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ BINARY CONFIG ----------------------
options.registry.html_form_builder_v12_field_binary = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.binary_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
// ------------------------ INPUT GROUP CONFIG ----------------------
options.registry.html_form_builder_v12_field_input_group = options.Class.extend({
    onBuilt: function() {
        var self = this;

    	this.template = 'html_form_builder_v12_snippets.input_group_config';
    	self.$modal = $( qweb.render(this.template, {}) );
...
options.registry.html_form_builder_v12_field = options.Class.extend({
    onBuilt: function() {
        var self = this;
        var form_id = this.$target.parents().closest(".html_form").attr('data-form-id')
        var form_model = this.$target.parents().closest(".html_form").attr('data-form-model')
...
options.registry.html_form_builder_v12_captcha = options.Class.extend({
    onBuilt: function() {
        var self = this;
        var form_id = this.$target.parents().closest(".html_form").attr('data-form-id')
