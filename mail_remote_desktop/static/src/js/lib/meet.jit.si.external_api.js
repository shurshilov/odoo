! function(e, t) {
  ...
  return function(e) {
    ...
    function u(e) {
      ...
      if (!n.host) {
        ...
        if (t) {
          ...
          e && (n.host = e, n.hostname = r, n.port = a), "/" === i && "/" !== s && (i = s)
        }
      }
    ...
    class g {
      constructor({
        ...
        this.postis = h()(function(e) {
          ...
          return e
        }({}, f, e)), this._receiveCallback = () => {}, this.postis.listen("message", e => this._receiveCallback(e))
      }
      dispose() {
        this.postis.destroy()
      }
    ...
    const m = s(window.location).jitsi_meet_external_api_id,
      y = {};
    let _;
    "number" == typeof m && (y.scope = "jitsi_meet_external_api_" + m), (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => _.setBackend(e);
    var b = n(4),
      w = n(0);
    ...
    function I(e, t = {}) {
      return u(function(e) {
        ...
        url: (t.noSSL?"http":"https")+'://'+e+'/#jitsi_meet_external_api_id='+C
      }))
    }
    ...
    class k extends r.a {
      constructor(e, ...t) {
        ...
        this._parentNode = s, this._url = I(e, {
          ...
          devices: h,
          userInfo: p
        }), this._createIFrame(r, i, u), this._transport = new v({
          backend: new g({
            postisOptions: {
      ...
      _createIFrame(e, t, n) {
        ...
        this._frame = document.createElement("iframe"), this._frame.allow = "camera; microphone; display-capture", this._frame.src = this._url, this._frame.name = i, this._frame.id = i, this._setSize(e, t), this._frame.setAttribute("allowFullScreen", "true"), this._frame.style.border = 0, n && (this._frame.onload = n), this._frame = this._parentNode.appendChild(this._frame)
      }
        ...
        this._transport.on("event", e => {
          ...
          switch (t) {
            case "video-conference-joined":
              void 0 !== this._tmpE2EEKey && (this.executeCommand(j.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = i, this._participants[i] = {
                avatarURL: n.avatarURL
              };
            case "participant-joined":
              this._participants[i] = this._participants[i] || {}, this._participants[i].displayName = n.displayName, this._participants[i].formattedDisplayName = n.formattedDisplayName, S(this, 1);
              break;
      ...
      executeCommand(e, ...t) {
        e in j ? this._transport.sendEvent({
          data: t,
          name: j[e]
