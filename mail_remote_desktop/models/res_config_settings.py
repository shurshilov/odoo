...
class ResConfigSettingsVOIP(models.TransientModel):
    ...
    def set_values(self):
        ...
        config_parameters.set_param("remote_desktop_voip_server", self.remote_desktop_voip_server)
        return res
    ...
    def get_values(self):
        ...
        res.update(
            remote_desktop_voip_server=self.env["ir.config_parameter"].get_param(
                "remote_desktop_voip_server"
            )
        )
        return res
