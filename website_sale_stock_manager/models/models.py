...
class ResConfigSettings(models.TransientModel):
    ...
    css_msg_in_stock = fields.Text(related="website_id.css_msg_in_stock", readonly=False)
    css_msg_out_stock = fields.Text(related="website_id.css_msg_out_stock", readonly=False)
