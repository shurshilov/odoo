openerp.mail = function (session) {
     ...
     */
        ...
        init: function (parent, datasets, options) {
            ...
            //_.bind( mail.ChatterUtils.get_attachment_url, this)
            // record options
       ...
       //     this.manager_id = datasets.manager_id || false, //MYYYY
            ...
            if (this.model == 'res.partner') {
                this.record_name = 'Partner Profile of1111 ' + this.record_name;
            }
            else if (this.model == 'hr.employee') {
                this.record_name = 'News from 1111' + this.record_name;
            }
        ...
        format_data: function () {
            ...
            if (this.author_id && this.author_id[1]) {//MYYY
        ...
        compute_emails_from: function () {
            ...
            _.each(messages, function (thread) {
                if (thread.author_id && !thread.author_id[0] &&
                    ...
                    self.recipients.push({  'full_name': '23434',//MYY
                                            'name': '555555',
