...
class ResConfigSettingsGDriveField(models.TransientModel):
    ...
    gdrivef_client_id = fields.Char(
        string="Google drive client id", help="Set value from your Google account"
    )
    gdrivef_scope = fields.Char(
        string="Google drive scope", default="https://www.googleapis.com/auth/drive"
    )
    ...
    def get_values(self):
        ...
        res.update(
            gdrivef_navbar_hidden=self.env["ir.config_parameter"].get_param("gdrivef_navbar_hidden")
        )
