...
class MailThread(models.AbstractModel):
    ...
    def message_post(self, **kwargs):
        if not self._context.get("auto_subscribe_recipients"):
            return super(MailThread, self.with_context(mail_post_autofollow=False)).message_post(
                **kwargs
            )
...
class MailComposer(models.TransientModel):
    ...
    auto_subscribe_recipients = fields.Boolean(string="Auto subscribe recipients")
