odoo.define("pos_create_sale_order.PosCreateSale", function (require) {
  "use strict";
  ...
  class PosCreateSale extends PosComponent {
    createSaleOrder() {
      let self = this;
  ...
  PosCreateSale.template = "PosCreateSale";
  Registries.Component.add(PosCreateSale);
  return PosCreateSale;
});
