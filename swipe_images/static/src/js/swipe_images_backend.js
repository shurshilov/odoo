        ...
        if (this.attrs.options.swipe_field) {
          if (this.recordData[this.attrs.options.swipe_field]) {
            ...
            var product_image_ids =
              this.recordData[this.attrs.options.swipe_field].data;
            ...
            if (
              self.$(".img.img-fluid").length &&
              self.$(".img.img-fluid").parent()
            )
            ...
            if (current_img.data("id") >= 0) {
              if (
                ...
                if (self.recordData.product_image_ids) {
                  ...
                  var time = new Date().getTime().toString();
                  var source_id =
                    "?model=product.image&field=image&id=" +
                    JSON.stringify(current_img.data("id")) +
                    "&unique=" +
                    time +
                    "#";
