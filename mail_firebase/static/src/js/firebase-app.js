!(function (e, t) {
  ...
  function X(l) {
    var c = {},
      ...
      u = {
        ...
        initializeApp: function (e, t) {
          ...
          if (g(c, n)) throw G.create("duplicate-app", { appName: n });
          var i = new l(e, r, u);
          return (c[n] = i);
        },
        app: f,
    ...
    function f(e) {
      if (!g(c, (e = e || Y))) throw G.create("no-app", { appName: e });
      return c[e];
    }
    function h(r) {
      var t,
  ...
  (oe = se).INTERNAL.registerComponent(
    ...
    oe.registerVersion($, "0.6.9", ae),
    oe.registerVersion("fire-js", "");
  return se.registerVersion("firebase", "7.17.1", "app"), se;
});
