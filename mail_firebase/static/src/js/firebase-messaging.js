    ...
    (function () {
      ...
      function me(e) {
        return he(e, function (e) {
          ...
          var t,
            n = e.authToken;
          return 1 === (t = n).requestStatus && t.requestTime + M < Date.now()
                          ...
                          switch (e.label) {
                            case 0:
                              return o.oldVersion < 2
                                ...
                                ? [
                                    4,
                                    (t = o.transaction.objectStore(Be))
                                      .index("fcmSenderId")
                                      .get(a),
                                  ]
                                : [2];
          ...
          return g(this, function (e) {
            switch (e.label) {
              case 0:
                return (t = Ge(i)), [4, He()];
              case 1:
                return [4, e.sent().transaction(We).objectStore(We).get(t)];
              case 2:
          ...
          return g(this, function (e) {
            switch (e.label) {
              ...
              case 3:
                ...
                e.label = 4;
              case 4:
                return e.trys.push([4, 6, , 7]), [4, ze(f, u.token)];
              case 5:
                return e.sent(), [3, 7];
              case 6:
          ...
          return g(this, function (e) {
            switch (e.label) {
              case 0:
                return [4, Ue(r)];
              case 1:
                return (t = e.sent()) ? [4, ze(r, t.token)] : [3, 4];
              case 2:
                return (
                  e.sent(),
                  [
