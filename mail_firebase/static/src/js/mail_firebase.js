...
odoo.define("firebase_discuss", function(require) {
    "use strict";
    ...
    Discuss.include({
        events: _.extend({}, Discuss.prototype.events, {
            'click .subscribe_firebase': '_onClickSubscribeFirebase',
        }),
      ...
      sendTokenToServer: function(currentToken){
            if (!this.isTokenSentToServer(currentToken)) {
                ...
                this._rpc({
                    route: '/mail/firebase_push_notifications',
                    params: {
        ...
        isTokenSentToServer: function(currentToken) {
            return window.localStorage.getItem('sentFirebaseMessagingTokenMail') == currentToken;
        },
                        ...
                        this.messaging.onMessage(function(payload) {
                            ...
                            if ('serviceWorker' in navigator) {
                              window.addEventListener('load', function() {
                                navigator.serviceWorker.register('/mail-firebase-messaging-sw.js').then(function(registration) {
