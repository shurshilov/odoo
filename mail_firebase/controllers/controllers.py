...
class FirebasePushNotifications(http.Controller):
    ...
    @http.route(["/mail/firebase_push_notifications/conf"], type="json", auth="user")
    def firebase_push_notifications_cond(self):
        ...
        conf = {
            ...
            "authDomain": config_parameters.get_param("mail_firebase_authDomain"),
            "databaseURL": config_parameters.get_param("mail_firebase_databaseURL"),
            "projectId": config_parameters.get_param("mail_firebase_projectId"),
            "storageBucket": config_parameters.get_param("mail_firebase_storageBucket"),
            "messagingSenderId": config_parameters.get_param("mail_firebase_messagingSenderId"),
            "appId": config_parameters.get_param("mail_firebase_appId"),
            "measurementId": config_parameters.get_param("mail_firebase_measurementId"),
        }
        return conf
    ...
    def firebase_message_sw2(self):
        env = request.env(user=SUPERUSER_ID)
        config_parameters = env["ir.config_parameter"]
        mail_firebase_apiKey = config_parameters.get_param("mail_firebase_apiKey")
        mail_firebase_authDomain = config_parameters.get_param("mail_firebase_authDomain")
        mail_firebase_databaseURL = config_parameters.get_param("mail_firebase_databaseURL")
        mail_firebase_projectId = config_parameters.get_param("mail_firebase_projectId")
        mail_firebase_storageBucket = config_parameters.get_param("mail_firebase_storageBucket")
        ...
        mail_firebase_measurementId = config_parameters.get_param("mail_firebase_measurementId")
    ...
    @http.route(["/mail-firebase-messaging-sw.js"], type="http", auth="public", website=True)
