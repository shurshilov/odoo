...
iceServers.iceServers.push({'urls': ['stun:stun.ekiga.net']});
	iceServers.iceServers[0].urls.push('stun:stun01.sipphone.com');
	iceServers.iceServers[0].urls.push('stun:stun.ekiga.net');
	iceServers.iceServers[0].urls.push('stun:stun.fwdnet.net');
	iceServers.iceServers[0].urls.push('stun:stun.ideasip.com');
	iceServers.iceServers[0].urls.push('stun:stun.iptel.org');
	iceServers.iceServers[0].urls.push('stun:stun.rixtelecom.se');
	iceServers.iceServers[0].urls.push('stun:stun.schlund.de');
	iceServers.iceServers[0].urls.push('stun:stun.l.google.com:19302');
	iceServers.iceServers[0].urls.push('stun:stun1.l.google.com:19302');
	iceServers.iceServers[0].urls.push('stun:stun2.l.google.com:19302');
	iceServers.iceServers[0].urls.push('stun:stun3.l.google.com:19302');
	iceServers.iceServers[0].urls.push('stun:stun4.l.google.com:19302');
	iceServers.iceServers[0].urls.push('stun:stunserver.org');
	iceServers.iceServers[0].urls.push('stun:stun.softjoys.com');
	iceServers.iceServers[0].urls.push('stun:stun.voiparound.com');
	iceServers.iceServers[0].urls.push('stun:stun.voipbuster.com');
	iceServers.iceServers[0].urls.push('stun:stun.voipstunt.com');
	iceServers.iceServers[0].urls.push('stun:stun.voxgratia.org');
	iceServers.iceServers[0].urls.push('stun:stun.xten.com');

	console.log(iceServers.iceServers[0].urls)
