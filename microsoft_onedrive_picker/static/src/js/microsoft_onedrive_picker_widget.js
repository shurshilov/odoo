...
odoo.define('microsoft_onedrive_picker_widget', function (require) {
    "use strict";
    ...
    var FieldPathOnedrivePicker = fields.UrlWidget.extend({
        template: 'FieldCloudOnedrive',
        tagName: 'a',
        ...
        _copyURLFromOnedrive: function (document){
            this.$input.val(document.webUrl)
            this.$el.text(document.webUrl)
            
            this.commitChanges()
            this._setValue(this._formatValue(document.webUrl));
    ...
    registry.add("onedrive_picker", FieldPathOnedrivePicker);
});
