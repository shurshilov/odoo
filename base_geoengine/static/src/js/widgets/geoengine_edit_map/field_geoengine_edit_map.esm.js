...
export class FieldGeoEngineEditMap extends Component {
  ...
  createVectorLayer() {
    ...
    const colorHex =
      this.props.color !== undefined ? this.props.color : "#ee9900";
...
registry
  .category("fields")
  .add("geo_multi_polygon", FieldGeoEngineEditMapMultiPolygon);
...
registry
  .category("fields")
  .add("geo_multi_point", FieldGeoEngineEditMapMultiPoint);
registry.category("fields").add("geo_line", FieldGeoEngineEditMapLine);
registry
  .category("fields")
  .add("geo_multi_line", FieldGeoEngineEditMapMultiLine);
