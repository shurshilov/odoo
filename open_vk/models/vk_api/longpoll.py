...
MESSAGE_EXTRA_FIELDS = ["peer_id", "timestamp", "subject", "text", "attachments", "random_id"]
MSGID = "message_id"
...
PARSE_MESSAGE_FLAGS_EVENTS = [VkEventType.MESSAGE_FLAGS_REPLACE, VkEventType.MESSAGE_NEW]
...
class Event:
    ...
    def _parse_chat_info(self):
        ...
        elif self.type_id in [
            VkChatEventType.USER_JOINED.value,
...
class VkLongPoll:
    ...
    def preload_message_events_data(self, events):
        ...
        messages_data = self.vk.method("messages.getById", {"message_ids": message_ids})
