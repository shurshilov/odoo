...
class VkBotEvent:
    ...
    __slots__ = ("raw", "t", "type", "obj", "object", "group_id")
...
class VkBotLongPoll:
    ...
    __slots__ = ("vk", "wait", "group_id", "url", "session", "key", "server", "ts")
    ...
    def _parse_event(self, raw_event):
        event_class = self.CLASS_BY_EVENT_TYPE.get(raw_event["type"], self.DEFAULT_EVENT_CLASS)
