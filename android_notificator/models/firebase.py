...
class Channel(models.Model):
    ...
    def _channel_message_notifications(self, message, message_format=False):
        ...
        """
        res = super()._channel_message_notifications(message, message_format=message_format)
...
class ResUsersFirebaseMessage(models.TransientModel):
    ...
    body = fields.Char(
        string="Body firebase message", required=True, default=lambda self: self._get_default_body()
    )
    icon = fields.Char(
        string="Icon URL firebase message", default=lambda self: self._get_default_icon()
    )
    image = fields.Char(
        string="Image URL firebase message", default=lambda self: self._get_default_image()
    )
    click_action = fields.Char(
        string="Action URL firebase message", default=lambda self: self._get_default_action()
    )
