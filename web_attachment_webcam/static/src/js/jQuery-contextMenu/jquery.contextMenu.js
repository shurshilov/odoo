  ...
  var // currently active contextMenu trigger
    ...
    handle = {
      ...
      key: function (e) {
        ...
        var getZIndexOfTriggerTarget = function (target) {
          if (target.style.zIndex !== "") {
            ...
            if (
              ...
              typeof target.offsetParent !== "undefined"
            ) {
              getZIndexOfTriggerTarget(target.offsetParent);
            } else if (
              target.parentElement !== null &&
              typeof target.parentElement !== "undefined"
            ) {
        ...
        if (
          opt.$menu &&
          parseInt(targetZIndex, 10) > parseInt(opt.$menu.css("zIndex"), 10)
        ) {
          return;
        }
        switch (e.keyCode) {
            ...
            if (item.icon) {
              if ($.isFunction(item.icon)) {
                ...
                if (
                  ...
                  $t.addClass(
                    root.classNames.icon + " " + root.classNames.icon + "--fa5",
                  );
        ...
        opt.$menu.children().each(function () {
          ...
          if (item.type) {
            ...
            switch (item.type) {
              ...
              case "select":
                item.$input.val(
                  (item.selected === 0 ? "0" : item.selected) || "",
                );
                break;
            }
          }
  ...
  $.fn.contextMenu = function (operation) {
    ...
    if (this.length > 0) {
      ...
      if (typeof operation === "undefined") {
        ...
        typeof operation.x !== "undefined" &&
        typeof operation.y !== "undefined"
      ) {
        this.first().trigger(
          $.Event("contextmenu", {
            pageX: operation.x,
