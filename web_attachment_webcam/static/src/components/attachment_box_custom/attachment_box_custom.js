...
odoo.define("web_attachment_webcam", function (require) {
  "use strict";

  const components = {
    AttachmentBox: require("mail/static/src/components/attachment_box/attachment_box.js"),
  };
  const AttachmentBoxWebcamDialog = require("web_attachment_webcam/static/src/components/attachment_webcam/attachment_webcam.js");
  const Dialog = require("web.OwlDialog");
  components.AttachmentBox.components.Dialog = Dialog;
  components.AttachmentBox.components.AttachmentBoxWebcamDialog =
    AttachmentBoxWebcamDialog;

  const { patch } = require("web.utils");
  const { Component, useState } = owl;
  const { useRef } = owl.hooks;

  patch(components.AttachmentBox, "web_attachment_webcam", {
    // constructor(...args) {
    //     this.super(...args);
    //     this.state = useState({
