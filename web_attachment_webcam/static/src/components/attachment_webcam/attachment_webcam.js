  ...
  function (require) {
    ...
    class AttachmentWebcamDialog extends Component {
      ...
      constructor(...args) {
        ...
        this.state = useState({
          snapshot:
            "/web_attachment_webcam/static/src/img/webcam_placeholder.png",
        });
      ...
      async willStart() {
        let options = {
          ...
          force_flash: false,
          fps: 45,
          swfURL: "/web_attachment_webcam/static/src/js/webcam.swf",
        };
    ...
    Object.assign(AttachmentWebcamDialog, {
      components,
      template: "mail.AttachmentWebcamDialog",
    });

    return AttachmentWebcamDialog;
  },
);
