...
class FileStation:
    ...
    def get_search_list(
        ...
        if task_id is None:
            return "Enter a correct taskid, choose one of the following: " + str(
                self._search_taskid_list
            )
        else:
    ...
    def get_favorite_list(
        self, offset=None, limit=None, sort_by=None, status_filter=None, additional=None
    ):
    ...
    def get_dir_status(self, taskid=None):
        ...
        if taskid is None and self._dir_taskid != "":
            ...
            return "Did you run start_dir_size_calc() first? No task id found!" + str(
                self._dir_taskid_list
            )
    ...
    def get_md5_status(self, taskid=None):
        ...
        if taskid is None and self._md5_calc_taskid != "":
            ...
            return "Did you run start_md5_calc() first? No task id found! " + str(
                self._md5_calc_taskid
            )
    ...
    def get_shared_link_list(
        self, offset=None, limit=None, sort_by=None, sort_direction=None, force_clean=None
    ):
        api_name = "SYNO.FileStation.Sharing"
        info = self.file_station_list[api_name]
        api_path = info["path"]
    ...
    def start_delete_task(
        self, path=None, accurate_progress=None, recursive=None, search_taskid=None
    ):
    ...
    def get_list_of_all_background_task(
        self, offset=None, limit=None, sort_by=None, sort_direction=None, api_filter=None
    ):
