...
class FileStation:
    def __init__(self, ip_address, port, username, password, secure=False):
        self.session = syn.Authentication(
            ip_address, port, username, password, secure
        )
    ...
    def search_start(
        ...
        return (
            "You can now check the status of request with get_search_list() , your id is: "
            + self._search_taskid
        )
    ...
    def stop_all_search_task(self):
        ...
        assert len(self._search_taskid_list) != 0, "Task list is empty" + str(
            self._search_taskid_list
        )
    ...
    def start_dir_size_calc(self, path=None):
        ...
        response_id = (
            '"'
            + self.request_data(api_name, api_path, req_param)["data"]["taskid"]
            + '"'
        )
        ...
        return (
            "You can now check the status of request with get_dir_status() , your id is: "
            + self._dir_taskid
        )
    ...
    def get_dir_status(self, taskid=None):
        ...
        if taskid is None and self._dir_taskid != "":
            ...
            return (
                "Did you run start_dir_size_calc() first? No task id found!"
                + str(self._dir_taskid_list)
            )
    ...
    def start_md5_calc(self, file_path=None):
        ...
        return (
            "You can now check the status of request with get_md5_status() , your id is: "
            + self._md5_calc_taskid
        )
    ...
    def check_permissions(
        self, path=None, filename=None, overwrite=None, create_only=None
    ):
    ...
    def upload_file(
        self, dest_path, file_path, create_parents=True, overwrite=True
    ):
    ...
    def create_sharing_link(
        self, path=None, password=None, date_expired=None, date_available=None
    ):
        api_name = "SYNO.FileStation.Sharing"
        info = self.file_station_list[api_name]
        api_path = info["path"]
    ...
    def create_folder(
        self, folder_path=None, name=None, force_parent=None, additional=None
    ):
    ...
    def rename_folder(
        self, path=None, name=None, additional=None, search_taskid=None
    ):
    ...
    def start_copy_move(
        ...
        return (
            "You can now check the status of request with get_copy_move_status() , "
    ...
    def start_delete_task(
        ...
        return (
            "You can now check the status of request with get_delete_status() , "
    ...
    def delete_blocking_function(
        self, path=None, recursive=None, search_taskid=None
    ):
        api_name = "SYNO.FileStation.Delete"
        info = self.file_station_list[api_name]
        api_path = info["path"]
    ...
    def start_extract_task(
        ...
        return (
            "You can now check the status of request with get_extract_status() , "
    ...
    def start_file_compression(
        ...
        return (
            "You can now check the status of request with get_compress_status() , "
