...
class DownloadStation:
    ...
    def set_server_config(
        self,
        bt_max_download=None,
        bt_max_upload=None,
        emule_max_download=None,
        emule_max_upload=None,
        nzb_max_download=None,
        http_max_download=None,
        ftp_max_download=None,
        emule_enabled=None,
        unzip_service_enabled=None,
    ...
    def start_bt_search(self, keyword=None, module="all"):
        ...
        return (
            "You can now check the status of request with get_bt_search_results(), your id is: "
            + self._bt_search_id
        )
