...
class CloudSync(base_api.BaseApi):
    ...
    def get_pkg_config(self) -> dict[str, object] | str:
        ...
        api_path = info["path"]
        req_param = {"version": info["minVersion"], "method": "get_config"}

        return self.request_data(api_name, api_path, req_param)

    def get_connections(
        self, group_by: str = "group_by_user"
    ) -> dict[str, object] | str:
    ...
    def get_task_cloud_folders(
        self, sess_id: int, remote_folder_id: str, path: str = "/"
    ) -> dict[str, object] | str:
    ...
    def set_relink_behavior(
        self, delete_from_cloud: bool
    ) -> dict[str, object] | str:
    ...
    def set_connection_schedule(
        self, conn_id: int, enable: bool, schedule_info: list[str] = []
    ) -> dict[str, object] | str:
    ...
    def connection_pause(self, conn_id: int = -1) -> dict[str, object] | str:
        ...
        info = self.gen_list[api_name]
        api_path = info["path"]
        req_param = {"version": info["minVersion"], "method": "pause"}
    ...
    def connection_resume(self, conn_id: int = -1) -> dict[str, object] | str:
        ...
        info = self.gen_list[api_name]
        api_path = info["path"]
        req_param = {"version": info["minVersion"], "method": "resume"}
