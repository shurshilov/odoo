...
class Virtualization(base_api.BaseApi):
    ...
    def delete_vm(
        self, guest_id: str | None = None, guest_name: str | None = None
    ) -> dict[str, object] | str:
        api_name = "SYNO.Virtualization.API.Guest"
        info = self.file_station_list[api_name]
        api_path = info["path"]
    ...
    def vm_power_on(
        ...
        if host_id is None and host_name is None:
            print(
                "host_id and host_name are not specified, it will follow autoselect option from the cluster settings"
            )
    ...
    def delete_image(
        self, image_id: str | None = None, image_name: str | None = None
    ) -> dict[str, object] | str:
        api_name = "SYNO.Virtualization.API.Guest.Image"
        info = self.file_station_list[api_name]
        api_path = info["path"]
    ...
    def create_image(
        ...
        storage_ids: str | None = None,
        type: str | None = None,
        ds_file_path: str | None = None,
        ...
        req_param = {
            "version": info["maxVersion"],
            "method": "create",
            "auto_clean_task": auto_clean_task,
        }
        ...
        if ds_file_path is None:
            return (
                "Specify file path, the path should begin with a shared folder"
            )
