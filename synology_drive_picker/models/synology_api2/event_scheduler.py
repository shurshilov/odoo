...
class EventScheduler(base_api.BaseApi):
    ...
    def get_task_results(self, task_name: str) -> dict[str, object] | str:
    ...
    def get_result_output(
        self, task_name: str, result_id: int
    ) -> dict[str, object] | str:
    ...
    def task_set_enable(
        self, task_name: str, enable: bool
    ) -> dict[str, object] | str:
    ...
    def task_run(self, task_name: str) -> dict[str, object] | str:
        ...
        info = self.gen_list[api_name]
        api_path = info["path"]
        req_param = {"version": 1, "method": "run", "task_name": task_name}

        return self.request_data(api_name, api_path, req_param)

    def task_delete(self, task_name: str) -> dict[str, object] | str:
        ...
        info = self.gen_list[api_name]
        api_path = info["path"]
        req_param = {"version": 1, "method": "delete", "task_name": task_name}
