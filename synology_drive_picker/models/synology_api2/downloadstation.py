...
class DownloadStation(base_api.BaseApi):
    ...
    def set_server_config(
        ...
        nzb_max_download: int | None = None,
        http_max_download: int | None = None,
        ftp_max_download: int | None = None,
        emule_enabled: bool | None = None,
        unzip_service_enabled: bool | None = None,
        default_destination: str | None = None,
        emule_default_destination: str | None = None,
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation.Info"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def schedule_set_config(
        self, enabled: bool = False, emule_enabled: bool = False
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation.Schedule"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def tasks_list(
        self,
        additional_param: str | list[str] | None = None,
        offset: int = 0,
        limit: int = -1,
    ) -> dict[str, object] | str:
    ...
    def tasks_info(
        self, task_id, additional_param: str | list[str] | None = None
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation" + self.download_st_version + ".Task"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def create_task(
        self, uri, additional_param: dict[str, object] | None = None
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation" + self.download_st_version + ".Task"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def edit_task(
        self, task_id: str, destination: str = "sharedfolder"
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation" + self.download_st_version + ".Task"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def refresh_rss_site(
        self, rss_id: str | None = None
    ) -> dict[str, object] | str:
        api_name = "SYNO.DownloadStation.RSS.Site"
        info = self.download_list[api_name]
        api_path = info["path"]
    ...
    def start_bt_search(
        self, keyword: str | None = None, module: str = "all"
    ) -> dict[str, object] | str:
        api_name = (
        ...
        self._bt_search_id = self.request_data(api_name, api_path, param)[
            "data"
        ]["taskid"]
        ...
        message = (
            ...
            "get_bt_search_results(), your id is: " + self._bt_search_id
        )
    ...
    def get_bt_search_results(
        ...
        if taskid is None:
            return "Enter a valid taskid, you can choose one of " + str(
    ...
    def clean_bt_search(
        self, taskid: str | list[str] | None = None
    ) -> dict[str, object] | str:
        api_name = (
            "SYNO.DownloadStation" + self.download_st_version + ".BTSearch"
        )
