from .error_codes import (
    auth_error_codes,
    download_station_error_codes,
    error_codes,
    file_station_error_codes,
    virtualization_error_codes,
)
...
class DownloadStationError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="DownloadStation Error: %i" % error_code, *args
            )
        return
...
class FileStationError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="FileStation Error: %i" % error_code, *args
            )
        return
...
class VirtualizationError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Virtualization Error: %i" % error_code, *args
            )
        return
...
class AudioStationError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="AudioStation Error: %i" % error_code, *args
            )
        return
...
class ActiveBackupError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="ActiveBackup Error: %i" % error_code, *args
            )
...
class BackupError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Backup Error: %i" % error_code, *args
            )
        return
...
class CertificateError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Certificate Error: %i" % error_code, *args
            )
        return
...
class CloudSyncError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Cloud Sync Error: %i" % error_code, *args
            )
        return
...
class DHCPServerError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="DHCPServer Error: %i" % error_code, *args
            )
        return
...
class DirectoryServerError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="DirectoryServer Error: %i" % error_code, *args
            )
        return
...
class DockerError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Docker Error: %i" % error_code, *args
            )
        return
...
class DriveAdminError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="DriveAdmin Error: %i" % error_code, *args
            )
        return
...
class LogCenterError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="LogCenter Error: %i" % error_code, *args
            )
        return
...
class NoteStationError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="NoteStation Error: %i" % error_code, *args
            )
        return
...
class OAUTHError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="OAUTH Error: %i" % error_code, *args
            )
        return
...
class PhotosError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="Photos Error: %i" % error_code, *args
            )
        return
...
class SecurityAdvisorError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="SecurityAdvisor Error: %i" % error_code, *args
            )
        return
...
class TaskSchedulerError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="TaskScheduler Error: %i" % error_code, *args
            )
        return
...
class EventSchedulerError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="EventScheduler Error: %i" % error_code, *args
            )
        return
...
class UniversalSearchError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="UniversalSearch Error: %i" % error_code, *args
            )
        return
...
class USBCopyError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="USBCopy Error: %i" % error_code, *args
            )
...
class CoreSysInfoError(SynoBaseException):
    ...
    def __init__(self, error_code: int, *args: object) -> None:
        ...
        if error_code in error_codes.keys():
            ...
            super().__init__(
                error_message="CoreSysInfo Error: %i" % error_code, *args
            )
        return
...
class UndefinedError(SynoBaseException):
    ...
    def __init__(self, error_code: int, api_name: str, *args: object) -> None:
        ...
        super().__init__(
            error_message="Undefined Error: API: %s, Code: %i"
            % (api_name, error_code),
            *args
        )
        return
