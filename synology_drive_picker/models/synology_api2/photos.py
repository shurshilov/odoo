...
class Photos(base_api.BaseApi):
    ...
    def list_folders(
        ...
        return self._list_folders(
            folder_id, limit, offset, additional, "SYNO.Foto.Browse.Folder"
        )

    def list_teams_folders(
        self,
        folder_id: int = 0,
        limit: int = 2000,
        offset: int = 0,
        ...
        return self._list_folders(
            folder_id, limit, offset, additional, "SYNO.FotoTeam.Browse.Folder"
        )
    ...
    def lookup_folder(self, path: str) -> dict[str, object] | str:
        return self._lookup_folder(
            path, "SYNO.FotoBrowse.Folder", "SYNO.Foto.Browse.Folder"
        )

    def lookup_team_folder(self, path: str) -> dict[str, object] | str:
        return self._lookup_folder(
            path, "SYNO.FotoTeam.Browse.Folder", "SYNO.FotoTeam.Browse.Folder"
        )

    def _lookup_folder(
        self, path: str, api_name_count: str, api_name_list: str
        ...
        for part in path.strip("/").split("/"):
            ...
            for offset in range(0, count, 1000):
                folders_response = self._list_folders(
                    parent,
                    limit=1000,
                    offset=offset,
                    additional=None,
    ...
    def get_album(
        self, album_id: str, additional: str | list[str] | None = None
    ) -> dict[str, object] | str:
