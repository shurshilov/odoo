...
class ActiveBackupBusiness(base_api.BaseApi):
    ...
    def backup_task_list(
        self, load_versions: bool = False, filter: dict[str, any] = {}
    ) -> dict[str, object] | str:
        """
    ...
    def backup_task_delete_versions(
        self, task_id: int, versions_ids: list[int]
    ) -> dict[str, object] | str:
        """
    ...
    def list_storage(self) -> dict[str, object] | str:
        ...
        req_param = {"version": "1", "method": "list_storage"}
