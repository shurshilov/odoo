    ...
    var DarkroomPluginCrop = function() {
        ...
        Darkroom.plugins.crop = Darkroom.Plugin.extend({
            ...
            initialize: function InitDarkroomCropPlugin() {
                ...
                this._renderCropZone(0,0,270,270);
            },
            ...
            cropCurrentZone: function(buttonSave = false) {
                if (!this.hasFocus()) {
                    return;
                }
                ...
                if (buttonSave==true){                        
                        ...
                        var activeModel = imageWidget.record.context.active_model;
                        var activeRecordId = imageWidget.record.context.active_record_id;
