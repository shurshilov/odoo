...
class ResConfigSettings(models.TransientModel):
    ...
    website_watermark_enable = fields.Boolean("Selection mode", default = get_default_website_watermark_enable)
    website_watermark_mode = fields.Selection([
        ('text', 'Watermark just text'),
        ('image', 'Watermark your own image'),
    ], string='Enable/Disable website watermark', default='image')
    ...
    def write(self, values):
        ...
        if self.website_watermark_image:
            if self.website_watermark_enable:
